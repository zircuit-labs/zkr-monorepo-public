...
func (_StandardBridge *StandardBridgeCaller) AccessController(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _StandardBridge.contract.Call(opts, &out, "accessController")
...
//
// Solidity: function accessController() view returns(address)
func (_StandardBridge *StandardBridgeSession) AccessController() (common.Address, error) {
	return _StandardBridge.Contract.AccessController(&_StandardBridge.CallOpts)
}

// AccessController is a free data retrieval call binding the contract method 0xbc43cbaf.
//
// Solidity: function accessController() view returns(address)
func (_StandardBridge *StandardBridgeCallerSession) AccessController() (common.Address, error) {
	return _StandardBridge.Contract.AccessController(&_StandardBridge.CallOpts)
}
