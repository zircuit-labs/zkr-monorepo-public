...
func readContractList(logger log.Logger, filePath string) (contractsList, error) {
	...
	err = json.Unmarshal(contractData, &contracts)
	return contracts, err
}
...
func writeContractArtifacts(logger log.Logger, tempDirPath, contractName string, abi, bytecode []byte) (abiFilePath, bytecodeFilePath string, err error) {
