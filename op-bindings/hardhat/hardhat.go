...
type Hardhat struct {
	...
	buildInfos  []*BuildInfo //nolint:unused // just ignore this
}
...
func (h *Hardhat) GetBuildInfo(name string) (*BuildInfo, error) {
	...
	// TODO: handle multiple contracts with same name when required
	if len(buildInfos) > 1 {
...
// TODO: handle fully qualified names properly
