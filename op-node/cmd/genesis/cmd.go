...
var (
	...
	l2Flags = []cli.Flag{
		...
		outfileL2Flag,
		outfileRollupFlag,
		// Set this flag only when you run l2-geth with ZKTrie enabled from genesis block
		// i.e. you have run `geth --zktrie-enabled=true init ...`
...
var Subcommands = cli.Commands{
	...
	},
	{
		...
		Action: func(ctx *cli.Context) error {
			...
			params.ZKTrieEnabled.Store(ctx.Bool(utils.ZKTrieEnabledFlag.Name))
			log.Info("Is using ZKTrie genesis?", "using", params.ZKTrieEnabled.Load())
			...
			log.Debug("Is ZKTrie block set?", "set", l2Genesis.Config != nil && l2Genesis.Config.ZKTrieSwitchBlock != nil)
