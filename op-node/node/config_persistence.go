...
var (
	_ ConfigPersistence = (*ActiveConfigPersistence)(nil)
	_ ConfigPersistence = DisabledConfigPersistence{}
)
...
func (p *ActiveConfigPersistence) persist(sequencerStarted bool) error {
	...
	tmpFile := p.file + ".tmp"
	file, err := os.OpenFile(tmpFile, os.O_WRONLY|os.O_CREATE|os.O_TRUNC, 0o644)
	if err != nil {
