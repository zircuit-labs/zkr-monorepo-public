...
import (
	...
	log "github.com/zircuit-labs/l2-geth-public/log"
	...
	p2p "github.com/zircuit-labs/zkr-monorepo-public/op-node/p2p"
	p2pMocks "github.com/zircuit-labs/zkr-monorepo-public/op-node/p2p/mocks"
	...
	testlog "github.com/zircuit-labs/zkr-monorepo-public/op-service/testlog"
)
...
func TestPeerScores(t *testing.T) {
	t.Skipf("Flaky test, fails most of the time. Seems like a race condition") // TODO:
