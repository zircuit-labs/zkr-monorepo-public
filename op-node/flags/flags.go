...
import (
	...
	openum "github.com/zircuit-labs/zkr-monorepo-public/op-service/enum"
...
var (
	...
	NATSEnabledFlag = &cli.BoolFlag{
		Name:     "nats.enabled",
		Usage:    "Enable writing data to nats",
		EnvVars:  prefixEnvVars("NATS_ENABLED"),
		Value:    false,
		Category: NATSCategory,
	}
	NATSStoreDirFlag = &cli.StringFlag{
		Name:     "nats.storedir",
		Usage:    "Directory in which to store JetStream data",
		EnvVars:  prefixEnvVars("NATS_STOREDIR"),
		Value:    "",
		Category: NATSCategory,
	}
)
