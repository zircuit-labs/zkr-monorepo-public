...
func TestCLSync(t *testing.T) {
	...
	a1L1Info, err := derive.L1InfoDepositBytes(cfg, cfg.Genesis.SystemConfig, refA1.SequenceNumber, aL1Info, nil, refA1.Time)
	...
	a2L1Info, err := derive.L1InfoDepositBytes(cfg, cfg.Genesis.SystemConfig, refA2.SequenceNumber, aL1Info, nil, refA2.Time)
	require.NoError(t, err)
