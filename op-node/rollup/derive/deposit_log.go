...
var (
	...
	DepositEventVersion0 = l1common.Hash{}
)
...
func MarshalDepositLogEvent(depositContractAddr common.Address, deposit *types.DepositTx) (*l1types.Log, error) {
	toBytes := common.Hash{}
	if deposit.To != nil {
		toBytes = eth.AddressAsLeftPaddedHash(*deposit.To)
	}
	topics := []l1common.Hash{
		l1common.Hash(DepositEventABIHash),
		l1common.Hash(eth.AddressAsLeftPaddedHash(deposit.From)),
		l1common.Hash(toBytes),
		l1common.Hash(DepositEventVersion0),
	}
	...
	return &l1types.Log{
		Address: l1common.Address(depositContractAddr),
		Topics:  topics,
		Data:    data,
		Removed: false,
