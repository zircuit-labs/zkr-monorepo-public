...
import (
	...
	derivetest "github.com/zircuit-labs/zkr-monorepo-public/op-node/rollup/derive/test"
...
func ChannelManagerReturnsErrReorg(t *testing.T, batchType uint) {
	...
	require.NoError(t, m.AddL2Block(a, derive.NewL1BlockInfo(&types.L1Info{})))
	require.NoError(t, m.AddL2Block(b, derive.NewL1BlockInfo(&types.L1Info{})))
	require.NoError(t, m.AddL2Block(c, derive.NewL1BlockInfo(&types.L1Info{})))
	require.ErrorIs(t, m.AddL2Block(x, derive.NewL1BlockInfo(&types.L1Info{})), ErrReorg)

	require.Equal(t, []*ChannelBlock{{block: a, l1info: derive.NewL1BlockInfo(&types.L1Info{})}, {block: b, l1info: derive.NewL1BlockInfo(&types.L1Info{})}, {block: c, l1info: derive.NewL1BlockInfo(&types.L1Info{})}}, m.blocks)
...
func ChannelManager_Clear(t *testing.T, batchType uint) {
	...
	require.NoError(m.AddL2Block(a, derive.NewL1BlockInfo(&types.L1Info{})))
	...
	require.NoError(m.AddL2Block(b, derive.NewL1BlockInfo(&types.L1Info{})))
...
func ChannelManagerCloseBeforeFirstUse(t *testing.T, batchType uint) {
	...
	err := m.AddL2Block(a, derive.NewL1BlockInfo(&types.L1Info{}))
...
func ChannelManagerCloseNoPendingChannel(t *testing.T, batchType uint) {
	...
	err = m.AddL2Block(b, derive.NewL1BlockInfo(&types.L1Info{}))
	require.NoError(err, "Failed to add L2 block")
...
func TestChannelManager_Close_PartiallyPendingChannel(t *testing.T) {
	...
	require.NoError(m.AddL2Block(a, derive.NewL1BlockInfo(&types.L1Info{})), "adding 1st L2 block")
	require.NoError(m.AddL2Block(b, derive.NewL1BlockInfo(&types.L1Info{})), "adding 2nd L2 block")
