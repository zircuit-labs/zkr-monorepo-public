...
func (s *channel) TxConfirmed(id string, inclusionBlock eth.BlockID) (bool, []*ChannelBlock) {
...
func (s *channel) AddBlock(block *types.Block, l1Info *derive.L1BlockInfo) error {
	return s.channelBuilder.AddBlock(block, l1Info)
}
