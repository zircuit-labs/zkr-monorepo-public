...
import (
	...
	l1dial "github.com/zircuit-labs/zkr-monorepo-public/op-service/sources/l1/dial"
	...
	"github.com/zircuit-labs/zkr-monorepo-public/op-batcher/rpc"
	...
	oprpc "github.com/zircuit-labs/zkr-monorepo-public/op-service/rpc"
...
func (bs *BatcherService) initRPCClients(ctx context.Context, cfg *CLIConfig) error {
	l1Client, err := l1dial.DialEthClientWithTimeout(ctx, dial.DefaultDialTimeout, bs.Log, cfg.L1EthRpc)
	if err != nil {
...
func (bs *BatcherService) initBalanceMonitor(cfg *CLIConfig) {
	if cfg.MetricsConfig.Enabled {
		bs.balanceMetricer = bs.Metrics.StartBalanceMetrics(bs.Log, bs.L1Client, l1common.Address(bs.TxManager.From()))
	}
}
...
func (bs *BatcherService) Name() string {
	return "op-batcher"
}
