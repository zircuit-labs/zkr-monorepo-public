...
import (
	...
	"github.com/zircuit-labs/zkr-monorepo-public/op-service/sources/l1/batching"
...
func (f *BasicRPCReceiptsFetcher) FetchReceipts(ctx context.Context, blockInfo l1eth.BlockInfo, txHashes []common.Hash) (types.Receipts, error) {
