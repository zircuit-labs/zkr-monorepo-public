...
var _ l1eth.BlockInfo = (*headerInfo)(nil)
...
type RPCHeader struct {
	...
	Bloom       l1eth.Bytes256   `json:"logsBloom"`
...
func (hdr *RPCHeader) Info(trustCache bool, mustBePostMerge bool) (l1eth.BlockInfo, error) {
	if mustBePostMerge {
...
func (hdr *RPCHeader) BlockID() l1eth.BlockID {
	return l1eth.BlockID{
		Hash:   hdr.Hash,
...
func (block *RPCBlock) Info(trustCache bool, mustBePostMerge bool) (l1eth.BlockInfo, types.Transactions, error) {
	if mustBePostMerge {
