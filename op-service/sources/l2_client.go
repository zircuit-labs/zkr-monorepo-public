...
func (s *L2Client) L2BlockRefByLabel(ctx context.Context, label eth.BlockLabel) (eth.L2BlockRef, error) {
	...
	ref, err := derive.PayloadToBlockRef(s.rollupCfg, envelope.ExecutionPayload, envelope.L1Info)
	if err != nil {
...
func (s *L2Client) SystemConfigByL2Hash(ctx context.Context, hash common.Hash) (eth.SystemConfig, error) {
	...
	cfg, err := derive.PayloadToSystemConfig(s.rollupCfg, envelope.ExecutionPayload, envelope.L1Info)
	if err != nil {
