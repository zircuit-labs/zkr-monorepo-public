...
func CLIFlagsWithCategory(envPrefix string, category string) []cli.Flag {
	return []cli.Flag{
		...
		&cli.GenericFlag{
			...
			Value:    NewFormatFlagValue(FormatTerminal),
...
// DefaultCLITerminalConfig creates a default
// color enabled terminal configuration.
func DefaultCLITerminalConfig() CLIConfig {
	return CLIConfig{
		Level:  log.LevelInfo,
