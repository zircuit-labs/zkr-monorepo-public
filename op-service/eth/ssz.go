...
const (
	...
	// https://github.com/zircuit-labs/consensus-specs/blob/ef434e87165e9a4c82a99f54ffd4974ae113f732/specs/bellatrix/beacon-chain.md#execution
	maxTransactionsPerPayload = 1 << 20

	// MAX_WITHDRAWALS_PER_PAYLOAD	 in consensus spec
	// https://github.com/zircuit-labs/consensus-specs/blob/dev/specs/capella/beacon-chain.md#execution
