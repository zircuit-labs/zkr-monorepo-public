...
import (
	...
	gstate "github.com/zircuit-labs/l2-geth-public/core/state"
	"github.com/zircuit-labs/l2-geth-public/core/types"
	"github.com/zircuit-labs/l2-geth-public/core/vm"
	tracelogger "github.com/zircuit-labs/l2-geth-public/eth/tracers/logger"
	...
	op_service "github.com/zircuit-labs/zkr-monorepo-public/op-service"
...
func fetchPrestate(ctx context.Context, cl *rpc.Client, dir string, txHash common.Hash) error {
	...
	if err := os.WriteFile(dest, result, 0o644); err != nil {
...
func simulate(ctx context.Context, logger log.Logger, conf *params.ChainConfig,
	prestatePath string, tx *types.Transaction, header *types.Header, doProfile bool,
) error {
	memDB := rawdb.NewMemoryDatabase()
	stateDB := gstate.NewDatabase(memDB)
	state, err := gstate.New(types.EmptyLegacyTrieRootHash, stateDB, nil)
	if err != nil {
