...
// GetPoseidonCodeHash implements vm.StateDB.
func (db *MemoryStateDB) GetPoseidonCodeHash(common.Address) common.Hash {
	panic("unimplemented")
}

// GetKeccakCodeHash implements vm.StateDB.
func (db *MemoryStateDB) GetKeccakCodeHash(add common.Address) common.Hash {
	return db.GetCodeHash(add)
}
