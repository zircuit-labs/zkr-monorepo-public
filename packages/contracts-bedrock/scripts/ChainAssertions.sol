...
library ChainAssertions {
    ...
    function checkSystemConfig(Types.ContractSet memory _contracts, DeployConfig _cfg, bool _isProxy) internal view {
        ...
        require(ForgeArtifacts.isInitialized(address(config)), "contract not initialized");
    ...
    function checkL1CrossDomainMessenger(Types.ContractSet memory _contracts, Vm _vm, bool _isProxy) internal view {
        ...
        require(ForgeArtifacts.isInitialized(address(messenger)), "contract not initialized");
        ...
        if (_isProxy) {
            ...
            uint256 xdmSenderSlot = uint256(1);
            bytes32 xdmSenderSlotValue = _vm.load(address(messenger), bytes32(xdmSenderSlot));
            require(address(uint160(uint256(xdmSenderSlotValue))) == Constants.DEFAULT_L2_SENDER);
        } else {
    ...
    function checkL1StandardBridge(Types.ContractSet memory _contracts, bool _isProxy) internal view {
        ...
        require(ForgeArtifacts.isInitialized(address(bridge)), "contract not initialized");
        ...
        if (_isProxy) {
            ...
            require(address(bridge.accessController()) == _contracts.SuperchainConfig);
        } else {
        ...
        view
    {
        ...
        require(ForgeArtifacts.isInitialized(address(oracle)), "contract not initialized");
    ...
    function checkOptimismMintableERC20Factory(Types.ContractSet memory _contracts, bool _isProxy) internal view {
        ...
        require(ForgeArtifacts.isInitialized(address(factory)), "contract not initialized");
    ...
    function checkOptimismPortal(Types.ContractSet memory _contracts, DeployConfig _cfg, bool _isProxy) internal view {
        ...
        require(ForgeArtifacts.isInitialized(address(portal)), "contract not initialized");
        ...
        view
    {
        ...
        require(ForgeArtifacts.isInitialized(address(superchainConfig)), "contract not initialized");
