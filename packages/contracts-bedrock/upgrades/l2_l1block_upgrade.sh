...
forge script -vvv scripts/upgrades/202-UpgradeL1Block.s.sol:UpgradeL1Block --rpc-url "${UPGRADE_RPC}" --broadcast --mnemonics "${MNEMONIC_DEPLOYER}" --sender "${SENDER}" --slow
