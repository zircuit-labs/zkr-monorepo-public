...
import (
	...
	"github.com/zircuit-labs/zkr-monorepo-public/op-e2e/e2eutils/receipts"
	"github.com/zircuit-labs/zkr-monorepo-public/op-e2e/e2eutils/transactions"
...
func TestERC20BridgeDeposits(t *testing.T) {
	...
	l1log := l1eth.ConvertL2LogToL1(depositEvent.Raw)
	depositTx, err := derive.UnmarshalDepositLogEvent(&l1log)
	require.NoError(t, err)
