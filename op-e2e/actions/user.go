...
import (
	...
	"github.com/zircuit-labs/zkr-monorepo-public/op-node/withdrawals"
...
func (s *CrossLayerUser) CheckDepositTx(t Testing, l1TxHash common.Hash, index int, l1Success, l2Success bool) {
	...
	if depositReceipt == nil {
		...
		l1Log := l1eth.ConvertL2LogToL1(*depositReceipt.Logs[index])
		reconstructedDep, err := derive.UnmarshalDepositLogEvent(&l1Log)
